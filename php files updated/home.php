...
<div class="container-fluid">
 ...
 Visit website : www.mayurik.com -->  
			...
			<div class="card dashboard">
				<div class="card-body">
						...
						<marquee behavior="alternate" style="color:red; font-weight: 400; font-size: 16px;" scrolldelay="300">Alert: Do not borrow more than you can afford to repay.</marquee>
				</div>
				...
				<div class="col-md-4">
                        <div class="card bg-primary text-white mb-3">
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class=" text-white stretched-link" href="lindex.php?page=payments">View Payments</a>
 ...
 Visit website : www.mayurik.com -->  
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class=" text-white stretched-link" href="lindex.php?page=borrowers">View Borrowers</a>
                                <div class=" text-white">
                  ...
                  <div class="col-md-4">
                        <div class="card bg-warning text-white mb-3">
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="text-white stretched-link" href="lindex.php?page=loans">View Loan List</a>
                                <div class=" text-white">
