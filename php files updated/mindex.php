...
<body style="background-size: 100%; background: url(images/mann.jpg)" class="bg-gradient-seconday">
 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
	  ...
	  <li class="nav-item ">  <a class="nav-link" href="lindex.php">Loans</a></li>
  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        <td>UGX <?php echo $row['balance'] ?></td>
