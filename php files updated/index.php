...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
    <img src="images/loogo.jpg" style="object-fit:cover;object-position:center center" width="30" height="30" class="d-inline-block align-top" alt="">
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welecome to Muni University Students SACCO</h4>
  ...
  <?php 
    ...
    <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowBlack" data-ride="carousel" >
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="images/juuj.jfif" alt="Second slide" style="max-height: 250px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/fair.jpg" alt="Third slide" style="max-height: 250px">
          </div>
