...
<body style="background: url(images/Bank.jpg);background-size: 80%">
<h1 class="alert alert-dark bg-gradient-dark rounded-0"><b><?php echo bankname; ?></b></h1>
<h2 style="color: mediumseagreen"><small><center><i><b>Welcome to Muni University Students SACCO, transact at affordable rates at Muni University.</b></i></center></small></h2>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 200px; background-color:darksalmon">
